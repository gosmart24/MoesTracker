...
public class TinyDB {
    ...
    public ArrayList<Object> getListObject(String key, Class<TrackerModel> mClass) {
        Gson gson = new Gson();
    ...
    public void putListObject(String key, ArrayList<TrackerModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (TrackerModel obj : objArray) {
